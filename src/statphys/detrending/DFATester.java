...
public class DFATester {
    ...
    public static void main(String args[]) throws Exception {
        ...
        Messreihe d1 = TestDataFactory.getDataSeriesRandomValues(N/100);
    ...
    //        String status = dfa.getStatus();
        ...
        // MultiChart.openAndStore(v, "fluctuation function F(s) [order:" + order + "] ", "log(s)", "log(F(s))", false, "./output", "DFA" + order + ".dat" , "?");
        MultiChart.open(k, "Kontrolldaten", "t", "y(t)", true, "?");
        MultiChart.open(vmr2, "alpha vs. beta", "beta", "alpha", true, "?");
        
        alphaVonI.writeToFile( new File( "./output/alphaVonI_" + N + "_werte.dat") );
